      ...
      >
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8 text-lg flex-1 justify-center">
            <a
              href="#home"
              className={`hover:text-blue-600 hover:bg-white px-4 py-2 rounded-full ${
          ...
          <div className="hidden md:flex items-center justify-end">
            <Link
              to="/"
              className="text-white bg-blue-600 px-4 py-2 rounded-full hover:text-blue-600 hover:bg-white"
            >
              Start a project
            </Link>
          </div>
